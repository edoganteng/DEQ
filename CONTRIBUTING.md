Contributing to Dequant
============================

The Dequant project operates an open contributor model where anyone is
...
The following applies to code changes to the Dequant project, and is not to be
confused with overall Dequant Network Protocol consensus changes.

Whether a pull request is merged into Dequant rests with the project merge
...
The project leader is the release manager for each Dequant release.
