                                                                            ...
                                                                            spinnerFrame(0)
{
	...
	QString windowTitle = tr("Dequant Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
	...
	aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Dequant"), this);
	aboutAction->setStatusTip(tr("Show information about Dequant"));
	...
	showHelpMessageAction->setStatusTip(tr("Show the Dequant help message to get a list with possible Dequant command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
	...
	QString toolTip = tr("Dequant client") + " " + networkStyle->getTitleAddText();
...
{
	QString strTitle = tr("Dequant"); // default title
