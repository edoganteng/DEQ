...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextDequant = QChar (0xA9) + QString (" 2018-%1 ").arg (COPYRIGHT_YEAR) + QString (tr("The Dequant developers"));
	...
	pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 48, copyrightTextDequant);
