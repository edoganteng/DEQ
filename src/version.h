...
static const int MIN_PEER_PROTO_VERSION_BEFORE_ENFORCEMENT = 89999;
static const int MIN_PEER_PROTO_VERSION_AFTER_ENFORCEMENT = 90000;

static const int MIN_PEER_PROTO_VERSION_MNW_VIN = 90000;
